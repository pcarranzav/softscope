...
#define HW_LCDIF_CTRL_ADDR  	(REGS_LCDIF_BASE + HW_LCDIF_CTRL)
#define HW_LCDIF_CTRL_SET_ADDR 	(REGS_LCDIF_BASE + HW_LCDIF_CTRL_SET)
#define HW_LCDIF_CTRL_CLR_ADDR 	(REGS_LCDIF_BASE + HW_LCDIF_CTRL_CLR)
#define HW_LCDIF_CTRL_TOG_ADDR 	(REGS_LCDIF_BASE + HW_LCDIF_CTRL_TOG)
